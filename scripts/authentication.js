...
// let btnSubmit = el_ui_mem_mo_bs_002.querySelector(".btn_submit");
...
function checkSubmit() {
  ...
  //   if (!item.value && item.attributes.tabindex.value != 4) {
...
function checkSubmitAlert() {
  ...
  // 성공 케이스
  if (
    inputItems[0].value === "홍길동" &&
    inputItems[1].value === "980411" &&
    inputItems[2].value === "1" &&
    selectItem.value === "SKT" &&
    inputItems[4].value === "010-1111-1111"
  ) {
    alert("성공 케이스입니다.");
    setTimeout(() => {
      ...
      collapse();
      hide();
      // window.location.replace(`${window.location.href.replace('login/MEM-MO-PG-001.html', 'login/MEM-MO-PG-003.html')}`);
    }, 1500);
  } else if (
    inputItems[0].value === "홍길동" &&
    inputItems[1].value === "980411" &&
    inputItems[2].value === "1" &&
    selectItem.value === "SKT" &&
    inputItems[4].value === "010-2222-2222"
  ) {
    alert("입력하신 전화번호가 존재하지 않아요. 다시 확인해주세요.");
    inActiveLoadingButton();
    collapse();
    hide();
  } else if (
    ...
    inputItems[2].value === "1" &&
    selectItem.value === "SKT" &&
    inputItems[4].value === "010-3333-3333"
  ) {
    alert("입력하신 정보가 정확하지 않아요. 다시 확인해 주세요.");
    inActiveLoadingButton();
    collapse();
    hide();
  } else {
